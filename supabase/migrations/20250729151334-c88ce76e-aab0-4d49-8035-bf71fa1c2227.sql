-- Update the welcome email (day 0) with proper HTML formatting
...
**How to Schedule:** You can access your booking account, schedule sessions, and make class changes anytime [here](https://app.arketa.com). Please note we have a 12-hour cancellation window, so be sure to make any updates at least 12 hours before your scheduled class.
...
-- Update the day 10 email with proper HTML formatting
UPDATE message_sequences 
SET content = 'Hi {{first_name}},
...
-- Update the final email (day 28) with better formatting
UPDATE message_sequences 
SET content = 'Hi {{first_name}},
