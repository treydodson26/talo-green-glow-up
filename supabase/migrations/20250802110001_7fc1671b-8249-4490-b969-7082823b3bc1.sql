...
SELECT 
  ...
  (SELECT COUNT(DISTINCT customer_id) FROM customer_engagement_stats WHERE engagement_level = 'never_booked' AND status = 'intro_trial') as intro_customers_never_booked,
  (SELECT COUNT(DISTINCT customer_id) FROM customer_engagement_stats WHERE engagement_level = 'booked_never_attended' AND status = 'intro_trial') as intro_customers_never_attended;